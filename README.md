...
**桌上正在看**：Hosek-Wilkie 官方 LUT 取代手調係數、磁偏角校正（行動 AR 模式）、HYG 15k 大量星表的 PM 重建、宜居帶 overlay 的 UI toggle + 樂觀邊界（runaway greenhouse / maximum greenhouse）。
