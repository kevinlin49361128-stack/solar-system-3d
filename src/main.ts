...
import { setAtmosphericConditions } from './physics/topocentric';
...
import { setupUiPersistence, setupPanelToggles } from './bootstrap/uiPersistence';
import { createReadouts } from './bootstrap/readouts';
import {
...
const readouts = createReadouts({ solarSystem, cameraCtl, clock, renderer });
...
function tick(now: number): void {
  ...
  readouts.updateObserverReticle();
  readouts.updateSelectionMarker();
  if (calcPanel.isOpen()) {
